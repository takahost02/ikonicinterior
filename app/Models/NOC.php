...
class NOC extends Model
{
    ...
    public static function defaultNocCertificate()
    {
        ...
        $defaultTemplate = [
            ...
            'he'=>'<p style="text-align: center;"><span style="font-size: 18pt;"><strong>אישור ללא התנגדות</strong></span></p>
            ...
            'tr' =>'<p style="text-align: center;"><span style="font-size: 18pt;"><strong>İtiraz Yok Sertifikası</strong></span></p>
