                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto d-flex mt-4">
                                        ...
                                        <a href="#" class="btn btn-sm btn-primary me-2" onclick="document.getElementById('report_bill_summary').submit(); return false;" data-bs-toggle="tooltip" title="{{__('Apply')}}" data-original-title="{{__('Apply')}}">
    ...
    <div id="printableArea">
        <div class="row mt-3">
            ...
            @if($filter['vender']!= __('All'))
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0">{{__('Vender')}} :</h7>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="tab-content" id="myTabContent2">
                                    <div class="table-responsive tab-pane fade fade" id="bills" role="tabpanel" aria-labelledby="profile-tab3">
