                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="row row-gap-1 justify-content-between align-items-center">
                                <div class="col-xl-3">
                                ...
                                <div class="col-xl-9">
                                    <div class="row justify-content-end align-items-center">
                                        ...
                                        <div class="col-auto mt-4">
                                            <a href="#" class="btn btn-sm btn-primary me-1" onclick="document.getElementById('monthly_cashflow').submit(); return false;" data-bs-toggle="tooltip" title="{{__('Apply')}}" data-original-title="{{__('apply')}}">
                ...
                <div class="card report-card h-100 mb-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0">{{__('Monthly Cashflow')}}
                            </p>
                        </div>
                    </div>
                </div>
