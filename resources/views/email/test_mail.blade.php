                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Subject : ') . 'Testing purpose mail send' }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal">{{ __('Feel free to reach out if you have any questions.') }}</i>
                                                                        </p>
                                                                        <p style="margin: 10px 0;"><i
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal"><b
                                                                                    style="font-weight:700">{{ isset(App\Models\Utility::settings()['company_name']) && !empty(App\Models\Utility::settings()['company_name']) ? App\Models\Utility::settings()['company_name'] : env('APP_NAME') }}</b></i>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
