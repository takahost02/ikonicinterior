                        ...
                        <div class="px-3 py-2 row align-items-center">
                            ...
                            <div class="col-auto">
                                <div class="action-btn ms-2">
                                    <a href="#" class="mx-3 btn btn-sm  align-items-center delete-checklist bg-danger" data-url="{{ route('checklist.destroy',[$task->project_id,$checklist->id]) }}">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto actions">
                                        <div class="action-btn me-2">
                                            <a href="{{asset(Storage::url('uploads/tasks/'.$file->file))}}" download class="mx-3 btn btn-sm  align-items-center  bg-secondary" role="button" data-bs-toggle="tooltip" title="{{__('Download')}}">
                                                <i class="ti ti-download text-white"></i>
                                            </a>
                                        </div>
                                        @auth('web')
                                            <div class="action-btn">
                                                <a href="#" class="mx-3 btn btn-sm  align-items-center delete-comment-file  bg-danger" data-url="{{ route('comment.destroy.file',[$task->project_id,$task->id,$file->id]) }}">
                                                    <i data-bs-toggle="tooltip" title="{{__('Delete')}}" class="ti ti-trash text-white"></i>
                                                </a>
                                            </div>
                                        @endauth
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <a href="#" class="avatar avatar-sm ms-2">
                                    <img data-toggle="tooltip" data-original-title="{{(!empty($user)?$user->name:'')}}" @if($user->avatar) src="{{asset('/storage/uploads/avatar/'.$user->avatar)}}" @else src="{{asset('/storage/uploads/avatar/avatar.png')}}" @endif title="{{ $user->name }}" class="wid-40 rounded border-2 border border-primary ml-3">
                                </a>
                            </div>
                            <div class="col ml-n2">
        ...
        <div class="card-footer">
            ...
            <div class="col-12 d-flex">
                <div class="avatar me-3">
                    <img data-original-title="{{(!empty(\Auth::user()) ? \Auth::user()->name:'')}}" @if(\Auth::user()->avatar) src="{{asset('/storage/uploads/avatar/'.\Auth::user()->avatar)}}" @else src="{{asset('/storage/uploads/avatar/avatar.png')}}" @endif title="{{ Auth::user()->name }}" class="wid-40 rounded border-2 border border-primary ml-3">
                </div>
