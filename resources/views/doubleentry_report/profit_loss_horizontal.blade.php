...
@section('action-btn')
    ...
    <div class="float-end me-2">
        <a href="{{ route('report.profit.loss', 'vertical') }}" class="btn btn-sm bg-light-blue-subtitle" data-bs-toggle="tooltip"
    ...
    <div class="row justify-content-center" id="printableArea">
        <div class="col-md-12">
            ...
            <div class="card-header">
                <h5>{{ 'Profit & Loss ' . Auth::user()->name . ' as of ' . $filter['startDateRange'] . ' to ' . $filter['endDateRange'] }}
                </h5>
            </div>
                <div class="card-body {{ $collapseView == 'expand' ? 'collapse-view' : '' }}">
                    ...
                    <div class="row row-gap-4">
                        <div class="col-md-6">
                            ...
                            <div class="border-start border-end overflow-auto">
                                                    ...
                                                    @foreach ($records as $key => $record)
                                                        ...
                                                        @if (
                                                            (!preg_match('/\btotal\b/i', $record['account_name']) && $record['account'] == '') ||
                                                                $record['account'] == 'subAccount')
                                                            <div
                                                                class="account-inner d-flex align-items-center justify-content-between ps-3 ms-3">
                                                                <p class="mb-2 ps-3"><a
                                                                        href="{{ route('report.ledger', $record['account_id']) }}?account={{ $record['account_id'] }}"
                                                                        class="text-primary">{{ $record['account_name'] }}</a>
                                                                </p>
