...
@section('content')
    ...
    {{Form::model($job,array('route' => array('job.update', $job->id), 'method' => 'PUT', 'class'=>'needs-validation', 'novalidate')) }}
    <div class="row mt-3">
        <div class="col-md-6 ">
                ...
                <div class="card-body job-create ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {!! Form::text('position', null, ['class' => 'form-control','required' => 'required', 'placeholder'=>__('Enter Positions')]) !!}
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" value="{{$job->skill}}" data-toggle="tags" name="skill" placeholder="Skill" required/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body " style="height: 440px">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control summernote-simple-2" name="description" id="exampleFormControlTextarea1" rows="15" required>{{$job->description}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-fluid">
                <div class="card-body"  style="height: 440px">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            <textarea class="form-control summernote-simple" name="requirement" id="exampleFormControlTextarea2" rows="8" required>{{$job->requirement}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
