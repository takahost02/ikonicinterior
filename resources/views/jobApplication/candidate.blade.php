                                    ...
                                    <td>
                                        ...
                                        @if (!empty($application->resume))
                                            <span class="action-btn me-2">
                                                <a class="mx-3 btn btn-sm align-items-center bg-primary "  href="{{$resumes. '/' . $application->resume }}"  data-bs-toggle="tooltip"
                                                   data-bs-original-title="{{ __('Download') }}"
                                                   download><i class="ti ti-download text-white"></i></a>
                                            </span>
                                            <div class="action-btn me-2">
                                                <a class="mx-3 btn btn-sm align-items-center bg-secondary " href="{{ $resumes . '/' . $application->resume }}" target="_blank"  >
                                    ...
                                    <td>
                                        @can('show job application')
                                            <div class="action-btn me-2">
                                                ...
                                                <a class="mx-3 btn btn-sm  align-items-center bg-warning" data-bs-toggle="tooltip" title="{{__('View')}}" data-title="{{__('Details')}}" href="{{ route('job-application.show',\Crypt::encrypt($application->id)) }}"> <i class="ti ti-eye text-white"></i></a>
                                            </div>
                                        @endcan
                                    </td>
                                </tr>
