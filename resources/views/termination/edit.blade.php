{{Form::model($termination,array('route' => array('termination.update', $termination->id), 'method' => 'PUT', 'class'=>'needs-validation', 'novalidate')) }}
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group  col-lg-6 col-md-6">
            ...
            <div class="text-xs mt-1">
                {{ __('Create termination type here.') }} <a href="{{ route('terminationtype.index') }}"><b>{{ __('Create termination type') }}</b></a>
            </div>
        </div>
        <div class="form-group  col-lg-6 col-md-6">
