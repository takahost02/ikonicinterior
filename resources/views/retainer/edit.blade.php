                    ...
                    // $('.totalAmount').html(subTotal.toFixed(2));
                        if (confirm('Are you sure you want to delete this element?')) {
                            ...
                            if (id != undefined && id != null && id != '') {
                                $.ajax({
                                    url: '{{route('retainer.product.destroy')}}',
                                    type: 'POST',
                                    headers: {
    ...
    function changeItem(element) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.ajax({
                    url: '{{route('retainer.items')}}',
                    type: 'GET',
                    headers: {
                        'X-CSRF-TOKEN': jQuery('#token').val()
                    },
                    data: {
                        'retainer_id': proposal_id,
                        'product_id': iteams_id,
                    },
                    cache: false,
                    success: function (data) {
...
@section('content')
    <div class="row">
        {{ Form::model($retainer, array('route' => array('retainer.update', $retainer->id), 'method' => 'PUT','class'=>'w-100 needs-validation','novalidate')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('proposal_number', __('Retainer Number'),['class'=>'form-label']) }}
                                        <div class="form-icon-user">
        ...
        <div class="col-12">
            ...
            <div class="card repeater" data-value='{{ json_encode($retainer->items) }}'>
                        ...
                        <table class="table  mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group pt-0 flex-nowrap">
                                    {{ Form::select('item', $product_services,null, array('class' => 'form-control select item','data-url'=>route('retainer.product'))) }}
                                </td>
                                <td>
