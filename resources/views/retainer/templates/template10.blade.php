                    ...
                    <tr>
                        ...
                        <td>
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td style="color: var(--theme-color);"><b>{{ __('Number:') }}</b> </td>
                                        <td class="text-right">
                                            {{ Utility::retainerNumberFormat($settings, $retainer->retainer_id) }}</td>
                                    </tr>
                                    <tr>
                                        <td style="color: var(--theme-color);"><b>{{ __('Issue Date:') }}</b></td>
                                        <td class="text-right">
                                            {{ Utility::dateFormat($settings, $retainer->issue_date) }}</td>
                                    </tr>
                                    <tr>
                                        <td style="color: var(--theme-color);"><b>{{__('Due Date:')}}</b></td>
                                        <td class="text-right">{{Utility::dateFormat($settings,$retainer->due_date)}}</td>
                                    </tr>
                                    @if (!empty($customFields) && count($retainer->customField) > 0)
                                        @foreach ($customFields as $field)
                                            <tr>
                                                <td>{{ $field->name }} :</td>
                                                <td> {{ !empty($retainer->customField) ? $retainer->customField[$field->id] : '-' }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
            ...
            <table class="add-border proposal-summary" style="margin-top: 30px;">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td>{{ Utility::priceFormat($settings, $retainer->totalRate) }}</td>
                        <td>{{ Utility::priceFormat($settings, $retainer->totalDiscount) }}</td>
                        <td>{{ Utility::priceFormat($settings, $retainer->totalTaxPrice) }}</td>
                        <td>{{ Utility::priceFormat($settings, $retainer->getSubTotal()) }}</td>
                    </tr>
                    <tr>
                        <td colspan="4"></td>
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    <td>{{ __('Discount') }}:</td>
                                    <td>{{ Utility::priceFormat($settings, $retainer->getTotalDiscount()) }}</td>
                                </tr>
