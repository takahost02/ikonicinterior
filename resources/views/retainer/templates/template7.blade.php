...
<body>
    <div class="proposal-preview-main" id="boxes">
        <div class="proposal-header" style="border-top: 15px solid var(--theme-color); background: #f8f8f8;">
            <table>
                <tbody>
                    <tr>
                        <td>
                            ...
                            <table class="no-space">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ Utility::dateFormat($settings, $retainer->due_date) }}</td>
                                    </tr>
        ...
        <div class="proposal-body" style="border-bottom: 15px solid var(--theme-color);">
            <table class="vertical-align-top">
                <tbody>
                    <tr>
