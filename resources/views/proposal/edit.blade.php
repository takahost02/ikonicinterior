                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (proposalItems != null) {
                                ...
                                $(el.parent().parent().parent().find('.quantity')).val(proposalItems
                                    .quantity);
                                $(el.parent().parent().parent().find('.price')).val(proposalItems
                                    .price);
                                $(el.parent().parent().parent().find('.discount')).val(proposalItems
                                    .discount);
