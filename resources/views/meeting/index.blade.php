...
@section('action-btn')
    <div class="float-end d-flex">
        @can('create meeting')
            <a href="{{ route('meeting.calender') }}" class="btn btn-sm bg-light-blue-subtitle me-2" data-bs-toggle="tooltip" title="{{__('Calender View')}}" data-original-title="{{__('Calendar View')}}">
                                    ...
                                    @if(Gate::check('edit meeting') || Gate::check('delete meeting'))
                                        <td>
                                            ...
                                            <div class="action-btn me-2">
                                                <a href="#" data-url="{{ URL::to('meeting/'.$meeting->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Meeting')}}" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                            </div>
                                            @endcan
                                            @can('delete meeting')
