    ...
    <div class="float-end">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create quotation')): ?>
            <a href="#" data-size="lg" data-url="<?php echo e(route('quotation.create')); ?>" data-ajax-popup="true"
                data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Quotataion Create')); ?>" class="btn btn-sm btn-primary">
                                                ...
                                                <span>
                                                    ...
                                                    <?php if($quotation->is_converted == 0): ?>
                                                        ...
                                                        <?php else: ?>
                                                            ...
                                                            <div class="action-btn me-2">
                                                                <a href="<?php echo e(route('pos.show', \Crypt::encrypt($quotation->converted_pos_id))); ?>" class="mx-3 btn btn-sm align-items-center bg-warning"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/quotation/index.blade.php ENDPATH**/ ?>