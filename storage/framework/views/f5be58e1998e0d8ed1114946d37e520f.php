<?php echo e(Form::open(['route' => ['quotations.create', 0], 'method' => 'post', 'class'=>'needs-validation', 'novalidate'])); ?>
...
<?php endif; ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('quotation_date', __('Quotation Date'),['class'=>'form-label'])); ?><?php if (isset($component)) { $__componentOriginaleab1765d328ab3f8835fc5d78676a070 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaleab1765d328ab3f8835fc5d78676a070 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.required','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/quotation/create.blade.php ENDPATH**/ ?>