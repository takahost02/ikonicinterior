    ...
    <div class="col-xl-4 col-sm-6 col-12 crm-dash-card">
        <div class="crm-card-inner d-flex align-items-center gap-3">
            ...
            <div class="crm-content d-flex align-items-center gap-2 flex-wrap justify-content-between">
                ...
                <h3 class="h4 mb-2"><?php echo e($crm_data['total_leads']); ?></h3>
            </div>
        </div>
    </div>
    <div class="col-xl-4 col-sm-6 col-12 crm-dash-card">
        <div class="crm-card-inner d-flex align-items-center gap-3">
            ...
            <div class="crm-content d-flex align-items-center gap-2 flex-wrap justify-content-between">
                ...
                <h3 class="h4 mb-2"><?php echo e($crm_data['total_deals']); ?></h3>
            </div>
        </div>
    </div>
    <div class="col-xl-4 col-sm-6 col-12 crm-dash-card">
        <div class="crm-card-inner d-flex align-items-center gap-3">
            ...
            <div class="crm-content d-flex align-items-center gap-2 flex-wrap justify-content-between">
                ...
                <h3 class="h4 mb-2"><?php echo e($crm_data['total_contracts']); ?></h3>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/dashboard/crm-dashboard.blade.php ENDPATH**/ ?>