                            ...
                            <div class="col-xl-10">
                                <div class="row row-gap-1">
                                    <div class="col-3">
                                        ...
                                        <div class="form-group-wrp d-flex align-items-center gap-3">
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <a href="<?php echo e(route('attendanceemployee.index')); ?>"
                                        ...
                                        <a href="#" data-size="md" data-bs-toggle="tooltip"
                                            title="<?php echo e(__('Import')); ?>" data-url="<?php echo e(route('attendance.file.import')); ?>"
                                            data-ajax-popup="true"
                                            data-title="<?php echo e(__('Import employee attendance CSV file')); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit attendance')): ?>
                                                    <div class="action-btn me-2">
                                                        <a href="#"
                                                            ...
                                                            data-title="<?php echo e(__('Edit Attendance')); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete attendance')): ?>
                                                    <div class="action-btn ">
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            data-confirm-yes="document.getElementById('delete-form-<?php echo e($attendance->id); ?>').submit();">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/attendance/index.blade.php ENDPATH**/ ?>