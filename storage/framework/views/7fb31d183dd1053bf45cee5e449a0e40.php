...
<div class="modal-body">
        ...
        <div class="col-8">
            <div class="d-flex radio-check">
                <div class="form-check form-check-inline">
                    <input type="radio" id="on" value="1" name="is_lead_active" class="form-check-input lead_radio" <?php echo e(($form->is_lead_active == 1) ? 'checked' : ''); ?>>
                    <label class="custom-control-label form-label" for="on"><?php echo e(__('On')); ?></label>
                </div>
                <div class="form-check form-check-inline">
                    <input type="radio" id="off" value="0" name="is_lead_active" class="form-check-input lead_radio" <?php echo e(($form->is_lead_active == 0) ? 'checked' : ''); ?>>
    ...
    <div id="lead_activated" class="d-none">
        <div class="row px-2">
            <div class="col-4">
                <div class="form-group">
                     <?php echo e(Form::label('subject_id', __('Subject'),['class'=>'form-label'])); ?>
            ...
            <div class="col-8">
                <div class="form-group">
                    <?php echo e(Form::select('phone_id', $types,null, array('class' => 'form-control','data-toggle'=>'select'))); ?>
            ...
            <div class="col-4 form-group">
                <?php echo e(Form::label('pipeline_id', __('Pipelines'),['class'=>'form-label'])); ?>
...
<?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/form_builder/form_field.blade.php ENDPATH**/ ?>