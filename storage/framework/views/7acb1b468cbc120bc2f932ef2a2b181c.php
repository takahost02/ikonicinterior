...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Deal Stage')); ?></li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <a href="#" data-size="md" data-url="<?php echo e(route('stages.create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create Deal Stage')); ?>" class="btn btn-sm btn-primary">
            ...
            <div class="row justify-content-center">
                ...
                <div class="card">
                    <div class="card-body">
                                        ...
                                        <?php $__currentLoopData = $pipeline['stages']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="d-flex align-items-center justify-content-between list-group-item" data-id="<?php echo e($stage->id); ?>">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit stage')): ?>
                                                        ...
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center bg-info" data-url="<?php echo e(URL::to('stages/'.$stage->id.'/edit')); ?>" data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Deal Stages')); ?>">
                                                    ...
                                                    <?php if(count($pipeline['stages'])): ?>
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete stage')): ?>
                                                            <div class="action-btn ">
                                                                <?php echo Form::open(['method' => 'DELETE', 'route' => ['stages.destroy', $stage->id]]); ?>
                        ...
                        <p class=" mt-4"><strong><?php echo e(__('Note')); ?> : </strong><b><?php echo e(__('You can easily change order of deal stage using drag & drop.')); ?></b></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/stages/index.blade.php ENDPATH**/ ?>