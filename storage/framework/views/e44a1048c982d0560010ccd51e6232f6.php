                            ...
                            <div class="col-xl-10">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <?php echo e(Form::text('date', isset($_GET['date'])?$_GET['date']:null, array('class' => 'form-control month-btn','id'=>'pc-daterangepicker-1','readonly', 'placeholder' => __('Select Date')))); ?>
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <a href="#" class="btn btn-sm btn-primary me-1" onclick="document.getElementById('revenue_form').submit(); return false;" data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>" data-original-title="<?php echo e(__('apply')); ?>">
                                ...
                                <tr class="font-style">
                                    ...
                                    <td>
                                        ...
                                        <?php if(!empty($revenue->add_receipt)): ?>
                                            <a  class=" bg-primary me-1 btn btn-sm align-items-center" href="<?php echo e($revenuepath . '/' . $revenue->add_receipt); ?>" download="" data-bs-toggle="tooltip" title="<?php echo e(__('Download')); ?>">
                                                <i class="ti ti-download text-white"></i>
                                            </a>
                                            <a href="<?php echo e($revenuepath . '/' . $revenue->add_receipt); ?>"  class=" bg-secondary  btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Preview')); ?>" target="_blank"><span class="btn-inner--icon"><i class="ti ti-crosshair text-white" ></i></span></a>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                                        ...
                                        <td class="Action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit revenue')): ?>
                                                    <div class="action-btn me-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center bg-info" data-url="<?php echo e(route('revenue.edit',$revenue->id)); ?>" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" data-title="<?php echo e(__('Edit Revenue')); ?>" data-bs-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/revenue/index.blade.php ENDPATH**/ ?>