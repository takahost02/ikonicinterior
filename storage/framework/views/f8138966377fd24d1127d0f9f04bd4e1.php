...
?>
<?php echo e(Form::model($role,array('route' => array('roles.update', $role->id), 'method' => 'PUT', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php endif; ?>
                <?php echo e(Form::text('name',null,array('class'=>'form-control','placeholder'=>__('Enter Role Name'), 'required' => 'required', (isset($role->name) && $role->name == 'Employee') ? 'readonly' : ''))); ?>
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <?php if(in_array($module.' lead to deal',(array) $permissions)): ?>
                                                        <?php if($key = array_search($module.' lead to deal',$permissions)): ?>
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                <?php echo e(Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input isscheck crm_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])); ?>
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <?php if(in_array('convert '.$module,(array) $permissions)): ?>
                                                        <?php if($key = array_search('convert '.$module,$permissions)): ?>
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                <?php echo e(Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input isscheck account_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])); ?>
...
<?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/role/edit.blade.php ENDPATH**/ ?>