        ...
        <div class="project-card-inner d-flex align-items-center gap-3">
            ...
            <div class="project-content d-flex align-items-start gap-2 justify-content-between flex-1">
                <div class="project-content-left">
                    <h2 class="h5 mb-2">
                        <a href="<?php echo e(route('projects.index')); ?>" class="dashboard-link"><?php echo e(__('Total Projects')); ?></a>
                    </h2>
                    <h3 class="h5 mb-0"><?php echo e($home_data['total_project']['total']); ?></h3>
                </div>
                <div class="project-right">
                    <div class="d-flex align-items-center gap-2">
                        <span><?php echo e($home_data['total_project']['percentage']); ?>%</span>
    ...
    <div class="col-xxl-4 col-md-6 col-12 project-dash-card">
        <div class="project-card-inner d-flex align-items-center gap-3">
            ...
            <div class="project-content d-flex align-items-start gap-2 justify-content-between flex-1">
                <div class="project-content-left">
                    <h2 class="h5 mb-2">
                        <a href="<?php echo e(route('taskBoard.view', 'list')); ?>"
                            class="dashboard-link"><?php echo e(__('Total Tasks')); ?></a>
                    </h2>
                    <h3 class="h5 mb-0"><?php echo e($home_data['total_task']['total']); ?></h3>
                </div>

                <div class="project-right">
                    <div class="d-flex align-items-center gap-2">
                        <span><?php echo e($home_data['total_task']['percentage']); ?>%</span>
                        <p class="mb-0"><?php echo e(__('Completed')); ?></p>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xxl-4 col-md-6 col-12 project-dash-card">
        <div class="project-card-inner d-flex align-items-center gap-3">
            ...
            <div class="project-content d-flex align-items-start gap-2 justify-content-between flex-1">
                <div class="project-content-left">
                    <h2 class="h5 mb-2">
                        <?php echo e(__('Total Expense')); ?>

                    </h2>
                    <h3 class="h5 mb-0"><?php echo e($home_data['total_expense']['total']); ?></h3>
                </div>
                <div class="project-right">
                    <div class="d-flex align-items-center gap-2">
                        <span><?php echo e($home_data['total_expense']['percentage']); ?>%</span>
                        <p class="mb-0"><?php echo e(__('Completed')); ?></p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/dashboard/project-dashboard.blade.php ENDPATH**/ ?>