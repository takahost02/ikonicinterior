...
<?php $__env->startSection('action-btn'); ?>
    <div class="d-flex">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create project task')): ?>
            <a href="#" data-size="lg" data-url="<?php echo e(route('projects.tasks.create', $project->id)); ?>"
                data-ajax-popup="true" data-bs-toggle="tooltip"
                title="<?php echo e(__('Create Task')); ?>" class="btn btn-sm btn-primary">
                    ...
                    <div class="col">
                        <div class="crm-sales-card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between gap-3">
                                ...
                                <span class="f-w-600 count"><?php echo e(count($tasks)); ?></span>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/project_task/index.blade.php ENDPATH**/ ?>