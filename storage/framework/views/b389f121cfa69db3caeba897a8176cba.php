                        ...
                        <div class="col-sm-6 col-12 dash-info-card">
                            <div class="info-card-inner card mb-0">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0"><?php echo e(\Auth::user()->countCustomers()); ?></h3>
                                </div>
                                <div class="info-content">
                                    <h2 class="h4 mb-0"><a href="<?php echo e(route('customer.index')); ?>"
                                            class="info-link dashboard-link"><?php echo e(__('Total Customers')); ?></a></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 dash-info-card">
                            <div class="info-card-inner card mb-0">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0"><?php echo e(\Auth::user()->countVenders()); ?></h3>
                                </div>
                                <div class="info-content">
                                    <h2 class="h4 mb-0"><a href="<?php echo e(route('vender.index')); ?>"
                                            class="info-link dashboard-link"><?php echo e(__('Total Vendors')); ?></a></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 dash-info-card">
                            <div class="info-card-inner card mb-0">
                                ...
                                <div class="info-content">
                                    <h2 class="h4 mb-0"><a href="<?php echo e(route('invoice.index')); ?>"
                                            class="info-link dashboard-link"><?php echo e(__('Total Invoices')); ?></a></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 dash-info-card">
                            <div class="info-card-inner card mb-0">
                                ...
                                <div class="info-content">
                                    <h2 class="h4 mb-0"><a href="<?php echo e(route('bill.index')); ?>"
                                            class="info-link dashboard-link"><?php echo e(__('Total Bills')); ?></a></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxl-5">
                    <div class="card income-card">
                        <div class="card-header header-icon py-3">
                            <h5><?php echo e(__('Income Vs Expense')); ?></h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="income-card-left">
                                    <div class="income-info iday">
                                        <div class="income-icon-wrp d-flex align-items-center">
                                            ...
                                            <div class="income-text">
                                                <span><?php echo e(__('Income Today')); ?></span>
                                            </div>
                                        </div>
                                        <h4 class="mb-2"><?php echo e(\Auth::user()->priceFormat(\Auth::user()->todayIncome())); ?></h4>
                                    ...
                                    <div class="income-info imonth">
                                        <div class="income-icon-wrp d-flex align-items-center">
                                            ...
                                            <div class="income-text">
                                                <span><?php echo e(__('Income This Month')); ?></span>
                                            </div>
                                        </div>
                                        <h4 class="mb-2"><?php echo e(\Auth::user()->priceFormat(\Auth::user()->incomeCurrentMonth())); ?></h4>
                                        <div class="progress-line"></div>
                                    </div>
                                </div>
                                <div class="income-card-right">
                                    <div class="income-info eday">
                                        <div class="income-icon-wrp d-flex align-items-center">
                                            ...
                                            <div class="income-text">
                                                <span><?php echo e(__('Expense Today')); ?></span>
                                            </div>
                                        </div>
                                        <h4 class="mb-2"><?php echo e(\Auth::user()->priceFormat(\Auth::user()->todayExpense())); ?></h4>
                                        <div class="progress-line"></div>
                                    </div>
                                    <div class="income-info emonth">
                                        <div class="income-icon-wrp d-flex align-items-center">
                                            ...
                                            <div class="income-text">
                                                <span><?php echo e(__('Expense This Month')); ?></span>
                                            </div>
                                        </div>
                                        <h4 class="mb-2"><?php echo e(\Auth::user()->priceFormat(\Auth::user()->expenseCurrentMonth())); ?></h4>
                                        <div class="progress-line"></div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-items-center mb-0 ">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($weeklyInvoice['invoiceTotal'])); ?></h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($weeklyInvoice['invoicePaid'])); ?></h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($weeklyInvoice['invoiceDue'])); ?></h4>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-items-center mb-0 ">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($monthlyInvoice['invoiceTotal'])); ?></h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($monthlyInvoice['invoicePaid'])); ?></h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($monthlyInvoice['invoiceDue'])); ?></h4>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-items-center mb-0 ">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($weeklyBill['billTotal'])); ?></h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($weeklyBill['billPaid'])); ?></h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($weeklyBill['billDue'])); ?></h4>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-items-center mb-0 ">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($monthlyBill['billTotal'])); ?></h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($monthlyBill['billPaid'])); ?></h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4><?php echo e(\Auth::user()->priceFormat($monthlyBill['billDue'])); ?></h4>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                                ...
                                                <span>
                                                    <span class="row align-items-center">
                                                        ...
                                                        <span class="col">
                                                            ...
                                                            <h6 class="mb-2 d-block"><?php echo e(number_format($goal->target($goal->type,$goal->from,$goal->to,$goal->amount)['percentage'], (int) Utility::getValByName('decimal_number'), '.', '')); ?>%</h6>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/dashboard/account-dashboard.blade.php ENDPATH**/ ?>