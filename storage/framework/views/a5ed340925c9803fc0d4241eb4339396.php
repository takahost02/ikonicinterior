                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::date('date', isset($_GET['date']) ? $_GET['date'] : '', ['class' => 'form-control', 'placeholder' => __('Select Date')])); ?>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::select('branch', $branch, isset($_GET['branch']) ? $_GET['branch'] : '', ['class' => 'form-control select', 'required'])); ?>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::select('department', $department, isset($_GET['department']) ? $_GET['department'] : '', ['class' => 'form-control select', 'required'])); ?>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header card-body table-border-style">
                    ...
                    <?php echo e(Form::open(['route' => ['attendanceemployee.bulkattendances'], 'method' => 'post'])); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div class="present_check_in <?php echo e(empty($attendance) ? 'd-none' : ''); ?> ">
                                                    <div class="d-flex align-items-center gap-3">
                                                        <label class="form-label mb-0"><?php echo e(__('In')); ?></label>
                                                        <div class="time-box">
                                                        ...
                                                        <label for="inputValue"
                                                            class="form-label mb-0"><?php echo e(__('Out')); ?></label>
                                                        <div class="time-box">
                                                            <input type="time" class="form-control timepicker"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/attendance/bulk.blade.php ENDPATH**/ ?>