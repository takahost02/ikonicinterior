                                    ...
                                    <?php if( Gate::check('edit indicator') ||Gate::check('delete indicator') || Gate::check('show indicator')): ?>
                                        <td>
                                            ...
                                            <div class="action-btn me-2">
                                                <a href="#" data-url="<?php echo e(route('indicator.show',$indicator->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Indicator Detail')); ?>" class="mx-3 btn btn-sm align-items-center bg-warning" data-bs-toggle="tooltip" title="<?php echo e(__('View')); ?>" data-original-title="<?php echo e(__('View Detail')); ?>">
                                                    <i class="ti ti-eye text-white"></i></a>
                                            </div>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit indicator')): ?>
                                            <div class="action-btn me-2">
                                                <a href="#" data-url="<?php echo e(route('indicator.edit',$indicator->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Edit Indicator')); ?>" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/indicator/index.blade.php ENDPATH**/ ?>