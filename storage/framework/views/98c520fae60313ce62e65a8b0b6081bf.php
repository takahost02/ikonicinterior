...
<?php $__env->startSection('action-btn'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create label')): ?>
        <div class="d-flex flex-wrap align-items-center gap-2">
            <a href="#" data-size="md" data-url="<?php echo e(route('labels.create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip"
                title="<?php echo e(__('Create Labels')); ?>" class="btn btn-sm btn-primary">
                ...
                <ul class="nav nav-pills nav-fill" id="pills-tab" role="tablist">
                    ...
                    <?php $__currentLoopData = $pipelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pipeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?php if($i == 0): ?> active <?php endif; ?>"
                                id="pills-user-tab-1" data-bs-toggle="pill" data-bs-target="#tab<?php echo e($key); ?>"
                                type="button"><?php echo e($pipeline['name']); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="tab-content" id="pills-tabContent">
                        <?php ($i = 0); ?>
                        <?php $__currentLoopData = $pipelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pipeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="tab-pane fade show <?php if($i == 0): ?> active <?php endif; ?>"
                                id="tab<?php echo e($key); ?>" role="tabpanel" aria-labelledby="pills-user-tab-1">
                                <ul class="list-group sortable">
                                    <?php $__currentLoopData = $pipeline['labels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="list-group-item" data-id="<?php echo e($label->id); ?>">
                                            <span class="text-dark"><?php echo e($label->name); ?></span>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit label')): ?>
                                                    <div class="action-btn me-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center bg-info"
                                                            data-url="<?php echo e(URL::to('labels/' . $label->id . '/edit')); ?>"
                                                            data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip"
                                                            title="<?php echo e(__('Edit')); ?>"
                                                            data-title="<?php echo e(__('Edit Labels')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/labels/index.blade.php ENDPATH**/ ?>