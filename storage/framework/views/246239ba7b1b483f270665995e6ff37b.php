    ...
    <?php if(!empty($employee)): ?>
        <div class="text-end">
            <div class="d-flex flex-wrap align-items-center justify-content-md-end gap-2 drp-languages">
                ...
                <ul class="list-unstyled mb-0">
                    <li class="dropdown dash-h-item status-drp">
                        ...
                        <div class="dropdown-menu icon-dropdown dash-h-dropdown">
                            ...
                            <a href="<?php echo e(route('exp.download.doc',$employee->id)); ?>" class=" btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks" ><i class="ti ti-download "></i><?php echo e(__('DOC')); ?></a></a>
                        </div>
                    </li>
                </ul>
                <ul class="list-unstyled mb-0">
                ...
                <a href="<?php echo e(route('employee.edit',\Illuminate\Support\Facades\Crypt::encrypt($employee->id))); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>"class="btn btn-sm btn-info">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/employee/show.blade.php ENDPATH**/ ?>