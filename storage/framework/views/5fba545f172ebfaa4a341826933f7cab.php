            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-xxl-6">
                        <div class="card">
                            ...
                            <div class="card-body dash-card-body">
                                <p><?php echo e(__('My Office Time: '.$officeTime['startTime'].' to '.$officeTime['endTime'])); ?></p>
                                <center>
                                    <div class="row">
                                        <div class="col-md-6">
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card list_card">
                            <div class="card-header">
                                <h5><?php echo e(__('Meeting List')); ?></h5>
                            </div>
                            <div class="card-body dash-card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="d-flex gap-1 team-lists horizontal-scroll-cards">
                                    ...
                                    ?>
                                        <div>
                                            <img src="<?php echo e($logo . $avatar); ?>" alt="" class="rounded border-2 border border-primary">
                                            <p class="mt-2 mb-1 p-0"><?php echo e($notClockIn->name); ?></p>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        <div class="col-xxl-12">
                            <div class="card staff-info-card-wrp">
                                <div class="card-body p-3">
                                    <h4 class="mb-3"><?php echo e(__('Staff')); ?></h4>
                                        ...
                                        <div class="col-xxl-6 col-xl-12 col-md-4 col-sm-6 col-12 staff-info-card">
                                            <div class="staff-info-inner d-flex align-items-center gap-3">
                                                ...
                                                <div class="staff-info">
                                                    <p class="mb-1 dashboard-link"><?php echo e(__('Total Staff')); ?></p>
                                                    <h4 class="mb-0"><?php echo e($countUser +   $countClient); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-xl-12 col-md-4 col-sm-6 col-12 staff-info-card">
                                            <div class="staff-info-inner d-flex align-items-center gap-3">
                                                ...
                                                <div class="staff-info">
                                                    <p class="mb-1">
                                                        <a href="<?php echo e(route('employee.index')); ?>" class="dashboard-link"><?php echo e(__('Total Employee')); ?></a>
                                                    </p>
                                                    <h4 class="mb-0"><?php echo e($countUser); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-xl-12 col-md-4 col-sm-6 col-12 staff-info-card">
                                            <div class="staff-info-inner d-flex align-items-center gap-3">
                                                ...
                                                <div class="staff-info">
                                                    <p class="mb-1">
                                                        <a href="<?php echo e(route('clients.index')); ?>" class="dashboard-link"><?php echo e(__('Total Client')); ?></a>
                                                    </p>
                                                    <h4 class="mb-0"><?php echo e($countClient); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xxl-12">
                            <div class="card staff-info-card-wrp">
                                <div class="card-body p-3">
                                    <h4 class="mb-3"><?php echo e(__('Job')); ?></h4>
                                    <div class="row row-gap-1">
                                        <div class="col-xxl-6 col-xl-12 col-md-4 col-sm-6 col-12 staff-info-card">
                                            <div class="staff-info-inner d-flex align-items-center gap-3">
                                                <div class="staff-info-icon">
                                                ...
                                                <div class="staff-info">
                                                    <p class="mb-1">
                                                        <a href="<?php echo e(route('job.index')); ?>" class="dashboard-link"><?php echo e(__('Total Jobs')); ?></a>
                                                    </p>
                                                    <h4 class="mb-0"><?php echo e($activeJob + $inActiveJOb); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-xl-12 col-md-4 col-sm-6 col-12 staff-info-card">
                                            <div class="staff-info-inner d-flex align-items-center gap-3">
                                                ...
                                                <div class="staff-info">
                                                    <p class="mb-1 dashboard-link"><?php echo e(__('Active Jobs')); ?></p>
                                                    <h4 class="mb-0"><?php echo e($activeJob); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-xl-12 col-md-4 col-sm-6 col-12 staff-info-card">
                                            <div class="staff-info-inner d-flex align-items-center gap-3">
                                                ...
                                                <div class="staff-info">
                                                    <p class="mb-1 dashboard-link"><?php echo e(__('Inactive Jobs')); ?></p>
                                                    <h4 class="mb-0"><?php echo e($inActiveJOb); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xxl-12">
                            <div class="card staff-info-card-wrp">
                                <div class="card-body p-3">
                                    <h4 class="mb-3"><?php echo e(__('Training')); ?></h4>
                                    <div class="row row-gap-1">
                                        <div class="col-xxl-6 col-xl-12 col-md-4 col-sm-6 col-12 staff-info-card">
                                            <div class="staff-info-inner d-flex align-items-center gap-3">
                                                <div class="staff-info-icon">
                                                ...
                                                <div class="staff-info">
                                                    <p class="mb-1">
                                                        <a href="<?php echo e(route('trainer.index')); ?>" class="dashboard-link"><?php echo e(__('Trainer')); ?></a>
                                                    </p>
                                                    <h4 class="mb-0"><?php echo e($countTrainer); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-xl-12 col-md-4 col-sm-6 col-12 staff-info-card">
                                            <div class="staff-info-inner d-flex align-items-center gap-3">
                                                ...
                                                <div class="staff-info">
                                                    <p class="mb-1 dashboard-link"><?php echo e(__('Active Training')); ?></p>
                                                    <h4 class="mb-0"><?php echo e($onGoingTraining); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-xl-12 col-md-4 col-sm-6 col-12 staff-info-card">
                                            <div class="staff-info-inner d-flex align-items-center gap-3">
                                                ...
                                                <div class="staff-info">
                                                    <p class="mb-1 dashboard-link"><?php echo e(__('Done Training')); ?></p>
                                                    <h4 class="mb-0"><?php echo e($doneTraining); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table align-items-center">
                                        ...
                                        <tbody class="list">
                                        <?php $__empty_2 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                            <tr>
                                                <td><?php echo e($announcement->title); ?></td>
                                                <td><?php echo e(\Auth::user()->dateFormat($announcement->start_date)); ?></td>
                                                <td><?php echo e(\Auth::user()->dateFormat($announcement->end_date)); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>