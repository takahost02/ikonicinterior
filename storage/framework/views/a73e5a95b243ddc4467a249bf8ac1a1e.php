            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data) {
                        ...
                        show_toastr('<?php echo e(__('error')); ?>', 'Status Update Failed!', 'error');
                    }
                    location.reload();
                }
        ...
        myDropzone = new Dropzone("#dropzonewidget", {
            ...
            success: function(file, response) {
                ...
                if (response.is_success) {
                    ...
                    show_toastr('<?php echo e(__('Error')); ?>', 'The attachment must be same as stoarge setting',
                        'Error');
                }
            },
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end d-flex align-items-center">
        <a href="<?php echo e(route('contract.download.pdf', \Crypt::encrypt($contract->id))); ?>"
            ...
            title="<?php echo e(__('Download')); ?>" target="_blanks">
            <i class="ti ti-download"></i>
        </a>
        <a href="<?php echo e(route('get.contract', $contract->id)); ?>" target="_blank"
        ...
        <?php if(\Auth::user()->type == 'company'): ?>
            <a href="<?php echo e(route('send.mail.contract', $contract->id)); ?>" class="btn btn-sm bg-warning-subtle btn-icon m-1"
            ...
            <a href="#" class="btn btn-sm btn-secondary btn-icon m-1" data-size="lg"
                data-url="<?php echo e(route('contract.copy', $contract->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip"
        ...
        <?php if(\Auth::user()->type == 'company'): ?>
            <a href="#" class="btn btn-sm btn-primary-subtle btn-icon m-1" data-size="lg"
                data-url="<?php echo e(route('signature', $contract->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip"
                data-bs-original-title="<?php echo e(__('Add signature')); ?>" data-title="<?php echo e(__('Add signature')); ?>">
                    ...
                    <div class="dropdown-menu dash-h-dropdown">
                        <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a class="dropdown-item status" data-id="<?php echo e($k); ?>"
                                ...
                                href="#"><?php echo e(ucfirst($status)); ?>
                        ...
                        <div class="row h-100">
                            <div class="col-12 leave-card mb-3">
                                <div class="leave-card-inner d-flex align-items-center gap-3">
                                    ...
                                    <div
                                        ...
                                        <h2 class="h4 mb-0"><?php echo e(__('Attachment')); ?></h2>
                                        <h3 class="h4 mb-2"><?php echo e(count($contract->files)); ?></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 leave-card mb-3">
                                <div class="leave-card-inner d-flex align-items-center gap-3">
                                    ...
                                    <div
                                        class="leave-info d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h2 class="h4 mb-0"><?php echo e(__('Comment')); ?></h2>
                                        <h3 class="h4 mb-2"><?php echo e(count($contract->comment)); ?></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 leave-card">
                                <div class="leave-card-inner d-flex align-items-center gap-3">
                                    ...
                                    <div
                                        class="leave-info d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h2 class="h4 mb-0"><?php echo e(__('Notes')); ?></h2>
                                        <h3 class="h4 mb-2"><?php echo e(count($contract->note)); ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <address class="mb-0 text-sm">
                                    <dl class="row mt-4 align-items-center">
                                        ...
                                        <dd class="col-sm-8 text-sm">
                                            <?php echo e(!empty($contract->projects) ? $contract->projects->project_name : '-'); ?>

                                        </dd>
                                        <dt class="col-sm-4 h6 text-sm"><?php echo e(__('Value')); ?></dt>
                                        <dd class="col-sm-8 text-sm"> <?php echo e(\Auth::user()->priceFormat($contract->value)); ?>

                                        </dd>
                                        <dt class="col-sm-4 h6 text-sm"><?php echo e(__('Type')); ?></dt>
                                        <dd class="col-sm-8 text-sm">
                                            <?php echo e(!empty($contract->types) ? $contract->types->name : '-'); ?></dd>
                                        ...
                                        <dd class="col-sm-8 text-sm"><?php echo e(Auth::user()->dateFormat($contract->start_date)); ?>

                                        </dd>
                                        <dt class="col-sm-4 h6 text-sm"><?php echo e(__('End Date')); ?></dt>
                                        <dd class="col-sm-8 text-sm"><?php echo e(Auth::user()->dateFormat($contract->end_date)); ?>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    ...
                                                    <p class="card-text small">
                                                        <?php if(!empty($file->files) && file_exists(storage_path('contract_attechment/' . $file->files))): ?>
                                                ...
                                                <?php if((\Auth::user()->type == 'company' && $contract->status == 'accept') || \Auth::user()->id == $file->user_id): ?>
                                ...
                                <div class="form-group mb-0 form-send w-100">
                                    <form method="post" class="card-comment-box" id="form-comment"
                                        ...
                                        <textarea rows="1" class="form-control" name="comment" data-toggle="autosize"
                                            placeholder="<?php echo e(__('Add a comment...')); ?>"></textarea>
                                    </form>
                                </div>
                            ...
                            <?php $__currentLoopData = $contract->comment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <a href="<?php echo e(!empty($user->avatar) ? $logo . '/' . $user->avatar : $logo . '/avatar.png'); ?>"
                                                ...
                                                <img class="rounded border-2 border border-primary" width="40"
                                                    height="40"
                                                    src="<?php echo e(!empty($user->avatar) ? $logo . '/' . $user->avatar : $logo . '/avatar.png'); ?>">
                                            </a>
                                        </div>
                                        ...
                                        <?php if((\Auth::user()->type == 'company' && $contract->status == 'accept') || \Auth::user()->id == $comment->user_id): ?>
                                            <div class="col-auto actions">
                                ...
                                <div class="form-group mb-0 form-send w-100">
                                    ...
                                    <div class="form-group">
                                        <textarea rows="3" class="form-control grammer_textarea" name="notes" data-toggle="autosize"
                                            placeholder="<?php echo e(__('Add a Notes...')); ?>" required></textarea>
                                    </div>
                            ...
                            <?php $__currentLoopData = $contract->note; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <p class="d-block h6 text-sm font-weight-light mb-0 text-break">
                                                <?php echo e($note->notes); ?></p>
                                            <small class="d-block"><?php echo e($note->created_at->diffForHumans()); ?></small>
                                        </div>

                                        <?php if((\Auth::user()->type == 'company' && $contract->status == 'accept') || \Auth::user()->id == $note->user_id): ?>
                                            <div class="col-auto actions">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/contract/show.blade.php ENDPATH**/ ?>