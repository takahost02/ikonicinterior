    ...
    <tfooter>
        <tr class="bg-primary">
            ...
            <?php $__currentLoopData = $totalDateTimes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $totaldatetime): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <td class="total-date-time"> <input class="form-control bg-transparent <?php echo e($totaldatetime != '00:00' ? 'border-dark' : 'border-dark'); ?>  wid-120" type="text" value="<?php echo e($totaldatetime != '00:00' ? $totaldatetime : '00:00'); ?>"> </td>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <td class="text-center total-value1">
                <input class="form-control bg-transparent <?php echo e($calculatedtotaltaskdatetime != '00:00' ? 'border-dark' : 'border-dark'); ?> wid-120" type="text" value="<?php echo e($calculatedtotaltaskdatetime != '00:00' ? $calculatedtotaltaskdatetime : '00:00'); ?>">
            </td>
        </tr>
    </tfooter>
</table>
...
<?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/projects/timesheets/week.blade.php ENDPATH**/ ?>