...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Proposal Create')); ?></li>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::open(array('url' => 'proposal','class'=>'w-100', 'class'=>'needs-validation', 'novalidate'))); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row row-gap-1">
                        <div class="col-md-6">
                            <div class="form-group mb-0" id="customer-box">
            ...
            <div class="card repeater">
                <div class="item-section">
                    <div class="card-header border-0 pb-0 d-flex justify-content-end">
                        <a href="#" data-repeater-create="" class="btn btn-primary d-flex align-items-center gap-1 justify-content-center" data-bs-toggle="modal" data-target="#add-bank">
...
<?php endif; ?></th>
            ...
            <div class="modal-footer">
                <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route("proposal.index")); ?>';" class="btn btn-secondary me-2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikonicinterior/accounts.ikonicinterior.com/resources/views/proposal/create.blade.php ENDPATH**/ ?>