...
Route::get('invoice/create/{cid}', [InvoiceController::class, 'createWithClient'])->name('invoice.create.client');
    ...
    Route::resource('payment', PaymentController::class)->middleware(['auth', 'XSS', 'revalidate'])->except(['show']);
