                ...
                <div class="col-xl-9">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <h5 class="mb-2">{{ __('Feature') }}</h5>
                                </div>
                                <div class="col switch-width text-end">
                                    <div class="form-group mb-0">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" class="" name="is_feature_cards_on"
                                                id="is_feature_cards_on"  {{ isset($settings['is_feature_cards_on']) && $settings['is_feature_cards_on'] == 'on' ? 'checked="checked"' : '' }}>
                                            <label class="custom-control-label" for="is_feature_cards_on"></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="{{ route('feature_create') }}" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" title="{{ __('Create Features') }}"
                                                        ...
                                                        <span>
                                                            <div class="action-btn me-2">
                                                                <a href="javascript:void(0)"
                                                                    ...
                                                                    data-title="{{ __('Edit Page') }}" data-size="lg"
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <h5 class="mb-2">{{ __('Feature Section Head') }}</h5>
                                </div>
                                <div class="col switch-width text-end">
                                    <div class="form-group mb-0">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" class="" name="is_feature_section_on"
                                                id="is_feature_section_on"  {{ isset($settings['is_feature_section_on']) && $settings['is_feature_section_on'] == 'on' ? 'checked="checked"' : '' }}>
                                            <label class="custom-control-label" for="is_feature_section_on"></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-lg-9 col-md-9 col-sm-9">
                                    <h5>{{ __('Features Block List') }}</h5>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="{{ route('features_create') }}" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" title="{{ __('Create Features Block') }}"
                                        class="btn btn-sm btn-primary">
                                        <i class="ti ti-plus text-light"></i>
                                    </a>
                                </div>
