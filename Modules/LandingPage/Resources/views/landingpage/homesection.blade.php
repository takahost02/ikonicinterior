                ...
                <div class="col-xl-9">
                    {{--  Start for all settings tab --}}
                        ...
                        <div class="card">
                            ...
                            {{ Form::open(['route' => 'homesection.store', 'method' => 'post', 'enctype' => 'multipart/form-data' ,'id' => 'imageUploadForm', 'class'=>'needs-validation', 'novalidate']) }}
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <div class="text-end">
                                                <button class="btn btn-sm btn-primary btn-icon m-1 " data-repeater-create type="button" data-bs-toggle="tooltip" title="{{ __('Create') }}" data-title="{{ __('Create') }}"><i class="ti ti-plus"></i></button>
                                                </div>
                                                                ...
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-auto">
                                                                        <p class="card-text small text-muted">
                                                                            ...
                                                                            <img src="{{ $logo.'/home_logo.png' }}" width="70px" alt="Image placeholder" data-dz-thumbnail="">

                                                                        </p>
                                                                    </div>
                                                                    <div class="col-auto actions">
                                                                        <a data-repeater-delete href="javascript:void(0)" class="action-item btn btn-sm btn-icon btn-danger repeater-action-btn ms-2" data-bs-toggle="tooltip" title="{{ __('Delete') }}" data-title="{{ __('Delete') }}">
                                                            ...
                                                            <div class="row align-items-center">
                                                                <div class="col ml-n2">
                                                                    <p class="card-text small text-muted">
                                                                        ...
                                                                        <img src="{{ $logo.'/'.$home_logo }}" width="70px" alt="Image placeholder" data-dz-thumbnail="">
                                                                    </p>
                                                                </div>
                                                                <div class="col-auto actions">
                                                                    <a class="action-item btn btn-sm btn-icon btn-primary" href="{{ $logo.'/'.$home_logo }}" download="" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Download') }}">
                                                                        <i class="ti ti-download text-white"></i>
                                                                    </a>
                                                                </div>
                                                                <div class="col-auto actions">
                                                                    <a class="action-item btn btn-sm btn-icon btn-danger delete-button" data-image="{{ $home_logo }}" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Delete') }}">
