...
<head>
    <title>{{ $setting['title_text'] ? $setting['title_text'] : config('app.name', 'ERPGo SaaS') }}</title>
    <!-- Meta -->
    <meta charset="utf-8" />
                                ...
                                <div class="card-body">
                                        ...
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="text-primary ti ti-circle-plus fs-4"></i></span>
                                        ...
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti {{ $value->account == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger' }} fs-4"></i></span>
                                                        {{ $value->account == 1 ? 'Enable' : 'Disable' }}
                                                    {{ __('Account') }}</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti {{ $value->crm == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger' }} fs-4"></i></span>
                                                        {{ $value->crm == 1 ? 'Enable' : 'Disable' }}
                                                    {{ __('CRM') }}</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti {{ $value->hrm == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger' }} fs-4"></i></span>
                                                        {{ $value->hrm == 1 ? 'Enable' : 'Disable' }}
                                                    {{ __('HRM') }}</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti {{ $value->project == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger' }} fs-4"></i></span>
                                                        {{ $value->project == 1 ? 'Enable' : 'Disable' }}
                                                    {{ __('Project') }}</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti {{ $value->pos == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger' }} fs-4"></i></span>
                                                        {{ $value->pos == 1 ? 'Enable' : 'Disable' }}
                                                    {{ __('POS') }}</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti {{ $value->chatgpt == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger' }} fs-4"></i></span>
                                                        {{ $value->chatgpt == 1 ? 'Enable' : 'Disable' }}
                                                    {{ __('ChatGPT') }}</label>
                                            </div>
                                        </li>
                                    ...
                                    <div class="d-grid">
                                        <a href="{{ Auth::check() ? route('stripe', \Illuminate\Support\Facades\Crypt::encrypt($value->id)) : route('register', ['plan' => \Illuminate\Support\Facades\Crypt::encrypt($value->id)]) }}"
                                            class="btn btn-primary rounded-pill">{{ __('Start with ') . ucfirst($value->name) }} <i
